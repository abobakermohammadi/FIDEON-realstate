...
Design target: quiet, editorial, local, premium, fast, human. Avoid generic AI-luxury patterns, oversized marketing copy, fake statistics, decorative sections without a job, and unnecessary global language.

Primary mobile task order: browse listings -> understand essentials -> WhatsApp/call/contact in one or two taps.
